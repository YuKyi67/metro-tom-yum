...
<body class="font-sans antialiased bg-base-100 min-h-screen">
    <div class="bg-primary/20 dark:bg-neutral shadow-2xl">
        <div class="border-b border-primary/10 dark:border-gray-700 p-2 sm:px-4">
            <p class="max-w-screen-xl mx-auto font-semibold text-sm">Welcome to Metro</p>
        </div>
        <header class="">
            <div class="navbar max-w-screen-xl mx-auto py-6">
